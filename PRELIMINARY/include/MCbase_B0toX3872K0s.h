...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         B0_MuMu_mu1_dr_Dimuon25_Jpsi[100];   //[nB0]
   ...
   Float_t         B0_MuMu_mu2_dr_Dimuon25_Jpsi[100];   //[nB0]
   ...
   MCbase_B0toX3872K0s(TTree *tree=0, const TString & tags = "UL_MC");
   virtual ~MCbase_B0toX3872K0s();
...
MCbase_B0toX3872K0s::~MCbase_B0toX3872K0s()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MCbase_B0toX3872K0s::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCbase_B0toX3872K0s::LoadTree(Long64_t entry)
{
...
void MCbase_B0toX3872K0s::Init(TTree *tree)
{
...
Bool_t MCbase_B0toX3872K0s::Notify()
{
...
void MCbase_B0toX3872K0s::Show(Long64_t entry)
{
...
Int_t MCbase_B0toX3872K0s::Cut(Long64_t entry)
{
...
#endif // #ifdef MCbase_B0toX3872K0s_cxx
