...
#ifndef PrepAnalysis_h
#define PrepAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   PrepAnalysis(TTree *tree=0);
   virtual ~PrepAnalysis();
...
#ifdef PrepAnalysis_cxx
PrepAnalysis::PrepAnalysis(TTree *tree) : fChain(0) 
{
...
PrepAnalysis::~PrepAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PrepAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PrepAnalysis::LoadTree(Long64_t entry)
{
...
void PrepAnalysis::Init(TTree *tree)
{
...
void PrepAnalysis::Show(Long64_t entry)
{
...
Int_t PrepAnalysis::Cut(Long64_t entry)
{
