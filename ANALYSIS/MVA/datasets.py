...
input_files = {
   ...
   # - 2022 -
   '2022_data'  : '/eos/home-n/npalmeri/B0toX3872K0s/data/Run3_2022_blind.root',  #single file only used for training
...
import pandas as pd
import numpy as np
def pre_process_data(dataset, features, training = True, channel = 'X3872', era = 'all', keep_nonmatch=False):  
   ...
   if era == 'all': bkg_dataset = dataset + '_data' 
   else: bkg_dataset = dataset + era + '_data'
