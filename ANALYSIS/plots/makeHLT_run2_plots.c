{
    ...
    compare_years("HLTemulation", "M_B0",    "M_X3872 < 3.75", 60, 5., 5.6, "M(B^{0}) GeV", "B0_mass_Psi");
    compare_years("HLTemulation", "M_B0",    "M_X3872 > 3.75", 60, 5., 5.6, "M(B^{0}) GeV", "B0_mass_X");
    ...
    compare_years("HLTemulation", "M_X3872", "M_X3872 < 3.75", 25, 3.50, 3.75,  "M(#psi (2S)) GeV", "Psi_mass_Psi");
    compare_years("HLTemulation", "M_X3872", "M_X3872 > 3.75", 25, 3.75, 4.0, "M(X_{3872}) GeV", "X_mass_X");
    ...
    compare_years("HLTemulation", "pTM_B0",           "", 30, 0., 15, "p_{T}(B^{0})/M_(B^{0})"); 
    compare_years("HLTemulation", "LxySignBSz_B0",    "", 50, 0., 100, "L_{xy}/#sigma B^{0}-BS_{z}");
    compare_years("HLTemulation", "SVprob_B0",        "", 20, 0., 1., "P_{sv}(B^{0})");
    gPad->SetLogy(1);
    ...
    compare_years("HLTemulation", "SVprob_PiPi",      "", 20, 0., 1., "P_{sv}(#pi #pi)");
